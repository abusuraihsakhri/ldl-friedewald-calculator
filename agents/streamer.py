"""
Live WebSocket Distributed Component Telemetry Streamer for ldl-friedewald-calculator.
"""
import json
import asyncio
...
class TelemetryBroadcaster:
    ...
    async def broadcast_event(self, event_type: str, data: Dict[str, Any]):
        msg = json.dumps({"system": "ldl-friedewald-calculator", "event_type": event_type, "payload": data})
